...
var journalistaude = []
journalist.forEach(str => { 
        if (str.match(/aude/) + str.match(/Aude/)) {
...
journalist.forEach(str => { 
        if (str.match(/_/)+str.match(/_/)){
         journalistunderscore.push(/_/);
        }
    });
...
//   )
  ...
  console.log('la position de epenser est'+journalistbis.indexOf('@epenser'));
